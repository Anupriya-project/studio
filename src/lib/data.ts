...
export const notes: Note[] = [
  ...
  },
  {
    ...
    description: 'Master conditional statements (if, elif, else) and loops (for, while) to control the flow of your programs.',
    pdfUrl: '/pdfs/control-flow.pdf',
    tags: ['beginner', 'control flow', 'loops'],
  },
  {
    id: '6',
    slug: 'data-structures',
    title: 'Python Data Structures',
    description: 'Covers lists, tuples, dictionaries, and sets. Essential for any Python developer.',
    pdfUrl: '/pdfs/python-data-structures.pdf',
  ...
  },
  {
    ...
    description: 'Learn to define and call your own functions, understand arguments, and return values.',
    pdfUrl: '/pdfs/python-functions.pdf',
  ...
  },
  {
    ...
    description: 'An advanced guide to understanding and creating your own decorators.',
    pdfUrl: '/pdfs/python-decorators.pdf',
  ...
  },
  {
    ...
    description: 'Understand how to handle errors gracefully using try, except, else, and finally blocks.',
    pdfUrl: '/pdfs/error-handling.pdf',
    tags: ['intermediate', 'errors', 'exceptions'],
  },
  {
    id: '10',
    slug: 'file-handling',
    title: 'File Handling in Python',
    description: "Learn how to read from and write to files using Python's built-in functions.",
    pdfUrl: '/pdfs/file-handling.pdf',
    tags: ['intermediate', 'files', 'I/O'],
  },
];
